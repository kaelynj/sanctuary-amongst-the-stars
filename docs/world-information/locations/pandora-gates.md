...
Currently, the stoically efficient Go-nin Group runs the Torii complex that houses the gate itself. Go-nin prides itself in its Japanese traditions, even going so far as to recover a Torii gate from a Shinto shrine on Earth to mark the entrance to the gate.

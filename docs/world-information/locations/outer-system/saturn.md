...
Things deteriorated, and the Extropians formed the Kronos Port Authority (KPA), which brought in Ultimate mercenaries to enforce their rules. The Ultimates took over the KPA, and have now forces a detente across the station.
...
### Salah
- **Habitat Types:** Hamilton Cylinder

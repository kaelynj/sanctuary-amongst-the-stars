...
#### Multiple defenders:
Some systems may have more than one defender present.  When it comes to active countermeasures and other actions, defenders choose to work together or separately.  If acting in convert, the other defenders provide a [teamwork bonus](../../dice-basics.md#teamwork); only the primary defender can use pools.  If acting individually, each defender relies on their own [Initiative](../../actions-initiative.md#initiative), [Skills](../../Skills.md) and [Pools](../../Pools.md).

---
sidebar_label: Psi-Gamma Sleights
---
...
> | Animal Control | Complex | Sustained | 6 | Take over a non-sapient animals' mine, teleoperate it like a drone. |
...
> | Deep Scan | Complex | Sustained | 6 | Retrieve 2 times from target's mind.  +2 per superior success. |
...
> | Induce Error | Complex | Minutes | 6 | The target automatically fails the next test they make using skill chose by async. |
> | Infectious Mind | Complex | Sustained | 4 | Share a triggered disorder or influence effect with the target. |
> | Influence | Complex | Actions Turns | 4 | Apply an Enhanced Behavior or Restricted Behavior (Level 2) trait. | 
